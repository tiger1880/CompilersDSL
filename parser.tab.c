...
{
       0,   171,   171,   172,   173,   174,   183,   183,   183,   208,
     208,   208,   232,   233,   236,   236,   238,   247,   262,   262,
     275,   276,   279,   280,   281,   282,   283,   284,   285,   286,
     289,   290,   293,   293,   296,   299,   300,   304,   306,   306,
     306,   309,   310,   339,   340,   343,   344,   345,   346,   349,
     350,   353,   364,   377,   389,   404,   405,   409,   411,   414,
     415,   418,   419,   420,   421,   422,   423,   424,   425,   426,
     427,   428,   429,   430,   431,   432,   433,   434,   435,   436,
     437,   438,   439,   440,   441,   442,   443,   444,   445,   446,
     447,   450,   451,   452,   456,   457,   458,   459,   463,   464,
     467,   474,   481,   488,   495,   502,   511,   512,   515,   516,
     520,   521,   522,   525,   535,   549,   550,   559,   566,   574,
     582,   592,   593,   596,   604,   607,   621,   634,   647,   660,
     664,   677,   686,   695,   696,   697,   702,   716,   725,   736,
     737,   740,   740,   772,   773,   776,   777,   782,   790,   791,
     792,   795,   796,   802,   803,   806,   806,   807,   807,   808,
     811,   812,   815,   817
};
#endif
...
#line 339 "parser.y"
                                                      {(yyval.main).eletype = (yyvsp[-3].main).eletype; construct_params.clear(); *(yyval.main).text = *(yyvsp[-3].main).text + "(" + *(yyvsp[-1].main).text +  ")" ;}
#line 1874 "parser.tab.c"
    break;

  case 44: /* construct: constructor '(' ')'  */
#line 340 "parser.y"
                                {(yyval.main).eletype = (yyvsp[-2].main).eletype; *(yyval.main).text = *(yyvsp[-2].main).text + "()" ;}
...
#line 404 "parser.y"
                                                            { (yyval.main).eletype = pointCheck((yyvsp[-5].main).eletype, (yyvsp[-3].main).eletype);  *(yyval.main).text = "(" + *(yyvsp[-5].main).text + "," + *(yyvsp[-3].main).text + "," + *(yyvsp[-1].main).text + ")"; }
#line 1989 "parser.tab.c"
    break;

  case 56: /* point: '(' expression ',' expression ')'  */
#line 405 "parser.y"
                                               { (yyval.main).eletype = pointCheck((yyvsp[-3].main).eletype, (yyvsp[-1].main).eletype);*(yyval.main).text = "(" + *(yyvsp[-3].main).text + "," + *(yyvsp[-1].main).text +  ")";}
...
#line 427 "parser.y"
                                             { (yyval.main).eletype = REAL; *(yyval.main).text = *(yyvsp[-2].main).text + *(yyvsp[-1].main).text + *(yyvsp[0].main).text ;}
...
#line 2199 "parser.tab.c"
  ...
  case 91: /* inside_norm: inside_norm '+' vertex  */
#line 450 "parser.y"
                                     { *(yyval.main).text = *(yyvsp[-2].main).text + "+" + *(yyvsp[0].main).text;}
#line 2205 "parser.tab.c"
    break;

  case 92: /* inside_norm: inside_norm '-' vertex  */
#line 451 "parser.y"
                                     { *(yyval.main).text = *(yyvsp[-2].main).text + "+" + *(yyvsp[0].main).text;}
#line 2211 "parser.tab.c"
    break;

  case 93: /* inside_norm: vertex  */
#line 452 "parser.y"
                                     { *(yyval.main).text = *(yyvsp[0].main).text;}
...
#line 463 "parser.y"
                                     {typeUpdate((yyvsp[-1].main).nameList, (yyvsp[-2].main).eletype);lineArrNo = 0; *(yyval.main).text = *(yyvsp[-2].main).text + *(yyvsp[-1].main).text + *(yyvsp[0].main).text; }
