...
{
       0,   199,   199,   200,   201,   216,   228,   228,   228,   257,
     257,   257,   283,   284,   287,   288,   291,   302,   320,   320,
     341,   349,   361,   362,   363,   364,   365,   366,   367,   368,
     371,   378,   381,   381,   390,   399,   400,   404,   406,   407,
     408,   411,   412,   416,   417,   420,   421,   424,   425,   428,
     429,   430,   431,   434,   435,   438,   449,   462,   474,   490,
     491,   495,   497,   500,   501,   504,   505,   511,   512,   513,
     514,   515,   516,   517,   518,   519,   520,   521,   522,   523,
     524,   525,   526,   527,   528,   529,   530,   531,   532,   533,
     534,   535,   536,   537,   538,   542,   543,   547,   548,   549,
     550,   554,   560,   563,   574,   585,   596,   607,   619,   637,
     649,   650,   653,   654,   658,   659,   660,   663,   673,   687,
     695,   704,   713,   724,   725,   728,   737,   740,   754,   768,
     781,   795,   800,   813,   823,   832,   833,   834,   839,   853,
     862,   874,   875,   878,   878,   911,   912,   915,   916,   921,
     929,   936,   943,   952,   959,   971,   972,   975,   975,   982,
     982,   989,   992,   993,   996,  1003
};
#endif
...
#line 1916 "new_parser.tab.c"
    break;

  case 32: /* $@6: %empty  */
#line 381 "new_parser.y"
            { addSymTabPtr(); }
#line 1922 "new_parser.tab.c"
    break;
...
#line 2016 "new_parser.tab.c"
    break;

  case 47: /* construct: constructor '(' construct_param_list ')'  */
#line 424 "new_parser.y"
                                                      {(yyval.main).eletype = (yyvsp[-3].main).eletype; construct_params.clear(); (yyval.main).text = new string;*(yyval.main).text = "new " + *(yyvsp[-3].main).text + "(" + *(yyvsp[-1].main).text + "," + center + "," + scale + ")" ;}
#line 2022 "new_parser.tab.c"
    break;

  case 48: /* construct: constructor '(' ')'  */
#line 425 "new_parser.y"
                                {(yyval.main).eletype = (yyvsp[-2].main).eletype; (yyval.main).text = new string;*(yyval.main).text = "new " + *(yyvsp[-2].main).text + "(" + center + "," + scale + ")" ;}
#line 2028 "new_parser.tab.c"
    break;
...
#line 2131 "new_parser.tab.c"
    break;

  case 59: /* point: '(' expression ',' expression ',' STRING_TOKEN ')'  */
#line 490 "new_parser.y"
                                                            { (yyval.main).eletype = pointCheck((yyvsp[-5].main).eletype, (yyvsp[-3].main).eletype); (yyval.main).text = new string; *(yyval.main).text = "new Point(" + *(yyvsp[-5].main).text + "," + *(yyvsp[-3].main).text + "," + *(yyvsp[-1].main).text + "," + scale + "," + center_x + "," + center_y +")"; }
#line 2137 "new_parser.tab.c"
    break;

  case 60: /* point: '(' expression ',' expression ')'  */
#line 491 "new_parser.y"
                                               { (yyval.main).eletype = pointCheck((yyvsp[-3].main).eletype, (yyvsp[-1].main).eletype);(yyval.main).text = new string;*(yyval.main).text = "new Point(" + *(yyvsp[-3].main).text + "," + *(yyvsp[-1].main).text +  "," + scale + "," + center_x + "," + center_y + ")";}
#line 2143 "new_parser.tab.c"
    break;
...
#line 2149 "new_parser.tab.c"
    break;

  case 62: /* vertex: point  */
#line 497 "new_parser.y"
                      { (yyval.main).text = new string;*(yyval.main).text = *(yyvsp[0].main).text; }
#line 2155 "new_parser.tab.c"
    break;
...
#line 2286 "new_parser.tab.c"
    break;

  case 84: /* expression: expression '>' expression  */
#line 528 "new_parser.y"
                                         { if(!(arithCompatible((yyvsp[-2].main).eletype) && arithCompatible((yyvsp[0].main).eletype)) && ((yyvsp[-2].main).eletype!=LABEL || (yyvsp[0].main).eletype != LABEL)) semanticError("Error: Semantic error incompatible datatype"); (yyval.main).eletype = BOOL; (yyval.main).text = new string;*(yyval.main).text = *(yyvsp[-2].main).text + ">" + *(yyvsp[0].main).text; }
#line 2292 "new_parser.tab.c"
    break;
...
#line 2388 "new_parser.tab.c"
    break;

  case 101: /* decl_stmt: DATATYPE id_list ENDLINE  */
#line 554 "new_parser.y"
                                     {typeUpdate((yyvsp[-1].main).nameList, (yyvsp[-2].main).eletype);(yyval.main).text = new string;
                                          if (*(yyvsp[-2].main).text == "Point ")
                                                 *(yyval.main).text = *(yyvsp[-2].main).text + *(yyvsp[-1].main).withStarText + ";"; 
                                          else 
                                                 *(yyval.main).text = *(yyvsp[-2].main).text + *(yyvsp[-1].main).text + ";" ;
                                          }
...
#line 560 "new_parser.y"
                                        {typeUpdate((yyvsp[-1].main).nameList, (yyvsp[-2].main).eletype);(yyval.main).text = new string; *(yyval.main).text = *(yyvsp[-2].main).text + *(yyvsp[-1].main).withStarText + ";" ;}
#line 2405 "new_parser.tab.c"
    break;
...
#line 564 "new_parser.y"
       {
              ...
              *(yyval.main).text = *(yyvsp[-5].main).text + "," + *(yyvsp[-3].main).text + *(yyvsp[-2].main).text + *(yyvsp[-1].main).text  + *(yyvsp[0].main).text;
              ...
              (yyval.main).withStarText = new string;
              *(yyval.main).withStarText = *(yyvsp[-5].main).withStarText + ", *" + *(yyvsp[-3].main).text + *(yyvsp[-2].main).text + *(yyvsp[-1].main).text  + *(yyvsp[0].main).text;
       }
#line 2420 "new_parser.tab.c"
    break;

  case 104: /* id_list: id_list ',' ID check_arr  */
#line 575 "new_parser.y"
       {
              ...
              *(yyval.main).text = *(yyvsp[-3].main).text + "," + *(yyvsp[-1].main).text + *(yyvsp[0].main).text;
              ...
              (yyval.main).withStarText = new string;
              *(yyval.main).withStarText = *(yyvsp[-3].main).withStarText + ", *" + *(yyvsp[-1].main).text + *(yyvsp[0].main).text;
       }
#line 2435 "new_parser.tab.c"
    break;

  case 105: /* id_list: id_list ',' ID decl_assign  */
#line 586 "new_parser.y"
       {
              (yyval.main).nameList = (yyvsp[-3].main).nameList;
              (yyval.main).nameList->push_back((yyvsp[-1].main).name);
...
#line 2450 "new_parser.tab.c"
    break;

  case 106: /* id_list: ID check_arr  */
#line 597 "new_parser.y"
       {
              ...
              *(yyval.main).text = *(yyvsp[-1].main).text + *(yyvsp[0].main).text;
              ...
              (yyval.main).withStarText = new string;
              *(yyval.main).withStarText = " *" + *(yyvsp[-1].main).text + *(yyvsp[0].main).text;
       }
...
#line 608 "new_parser.y"
       {
              ...
              *(yyval.main).text = *(yyvsp[-3].main).text + *(yyvsp[-2].main).text + *(yyvsp[-1].main).text + *(yyvsp[0].main).text;
              ...
              (yyval.main).withStarText = new string;
              *(yyval.main).withStarText = " *" +  *(yyvsp[-3].main).text + *(yyvsp[-2].main).text + *(yyvsp[-1].main).text + *(yyvsp[0].main).text;
...
#line 619 "new_parser.y"
              ...
              *(yyval.main).text = *(yyvsp[-3].main).text + *(yyvsp[-2].main).text  + "=" + translateLineArr(*(yyvsp[0].main).text);
              ...
              (yyval.main).withStarText = new string;
              *(yyval.main).withStarText = " *" +  *(yyvsp[-3].main).text + *(yyvsp[-2].main).text  + "=" + translateLineArr(*(yyvsp[0].main).text);

       }
#line 2504 "new_parser.tab.c"
    break;
...
#line 2626 "new_parser.tab.c"
    break;

  case 122: /* comma_arr_assign: arr_assign  */
#line 714 "new_parser.y"
              {
                     (yyval.main).listAndType.dimList = new vector<int>; 
...
#line 2639 "new_parser.tab.c"
    break;

  case 123: /* arr1d_in_list: mult_elements  */
#line 724 "new_parser.y"
...
#line 2664 "new_parser.tab.c"
    break;

  case 126: /* mult_elements: expression  */
#line 737 "new_parser.y"
...
#line 2670 "new_parser.tab.c"
    break;

  case 127: /* const_expr: const_expr '+' const_expr  */
#line 740 "new_parser.y"
...
#line 2689 "new_parser.tab.c"
    break;

  case 128: /* const_expr: const_expr '-' const_expr  */
#line 754 "new_parser.y"
...
#line 2708 "new_parser.tab.c"
    break;

  case 129: /* const_expr: const_expr '*' const_expr  */
#line 768 "new_parser.y"
...
#line 2726 "new_parser.tab.c"
    break;

  case 130: /* const_expr: const_expr '/' const_expr  */
#line 781 "new_parser.y"
                                   {(yyval.main).constExp.eletype = mulTypeCheck((yyvsp[-2].main).constExp.eletype, (yyvsp[0].main).constExp.eletype);
...
#line 2745 "new_parser.tab.c"
    break;

  case 131: /* const_expr: const_expr '%' const_expr  */
#line 795 "new_parser.y"
...
#line 2755 "new_parser.tab.c"
    break;

  case 132: /* const_expr: const_expr '^' const_expr  */
#line 800 "new_parser.y"
                                   {(yyval.main).constExp.eletype = mulTypeCheck((yyvsp[-2].main).constExp.eletype, (yyvsp[0].main).constExp.eletype);
...
#line 2788 "new_parser.tab.c"
    break;

  case 134: /* const_expr: '(' const_expr ')'  */
#line 823 "new_parser.y"
                            {      
...
#line 2802 "new_parser.tab.c"
    break;

  case 135: /* const_expr: FLOATS  */
#line 832 "new_parser.y"
...
#line 2852 "new_parser.tab.c"
    break;

  case 140: /* memb_access: ID arr_access  */
#line 862 "new_parser.y"
                              {
                     int count = checkDims((yyvsp[-1].main).name,(yyvsp[0].main).count);
...
#line 2866 "new_parser.tab.c"
    break;

  case 141: /* arr_access: arr_access '[' expression ']'  */
#line 874 "new_parser.y"
...
#line 2937 "new_parser.tab.c"
    break;

  case 148: /* empty_space: %empty  */
#line 916 "new_parser.y"
                                  { (yyval.main).text = new string;*(yyval.main).text = "";}
#line 2943 "new_parser.tab.c"
    break;

  case 149: /* cond_stmt: IF '(' expression ')' empty_space stmt_block ENDLINE  */
#line 922 "new_parser.y"
              {     
                     (yyval.main).stopAdvanceFound = (yyvsp[-1].main).stopAdvanceFound;
