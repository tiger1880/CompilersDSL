...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    ENDLINE = 284,                 /* ENDLINE  */
    ID = 285,                      /* ID  */
    TRICONSTRUCT = 286,            /* TRICONSTRUCT  */
    CIRCLECONSTRUCT = 287,         /* CIRCLECONSTRUCT  */
    PARACONSTRUCT = 288,           /* PARACONSTRUCT  */
    REGPOLYCONSTRUCT = 289,        /* REGPOLYCONSTRUCT  */
    NOT = 290,                     /* NOT  */
    AND = 291,                     /* AND  */
    OR = 292,                      /* OR  */
    SCALE = 293,                   /* SCALE  */
