...
static const yytype_int16 yyrline[] =
{
     ...
     562,   566,   567,   570,   578,   586,   594,   602,   610,   625,
     635,   636,   639,   640,   644,   645,   646,   649,   659,   673,
     681,   690,   699,   710,   711,   714,   723,   726,   740,   754,
     767,   781,   786,   799,   809,   818,   819,   820,   825,   839,
     848,   860,   861,   864,   864,   897,   898,   901,   902,   907,
     915,   922,   929,   938,   945,   957,   958,   961,   961,   968,
     968,   975,   978,   979,   982,   989
};
#endif
...
static const yytype_int16 yypact[] =
{
    ...
    -193,   457,  -193,   155,   158,   100,   180,   901,   162,   193,
     ...
     138,    25,    25,    25,    25,    25,    25,  -193,   388,    13,
      13,  -193,   357,  -193,   200,  -193,  -193,   224,  -193,   201,
    -193,   457,  -193,  -193,   202,   507,   507,   901,  -193,   204,
    -193,   179,  -193,  -193,   507,  -193,   507,  -193,    87,    87,
     190,   190,   190,   190,   901,  -193,    14,   184,   188,  -193,
    -193,    33,    33,  -193,   191,   207,   192,  -193,   120,   205,
     901,   198,   209,   189,   213,   671,   180,   901,   191,  -193,
    -193,   507,  -193,  -193,  -193,  -193,  -193,   215,  -193,   137,
    -193,  -193,  -193,  -193,  -193,   226,  -193,  -193,   901,   507,
     180,   219,  -193,   -18,   180,   180,   227,   786,   240,   507,
     180,  -193,  -193,  -193,  -193,   507,  -193,  -193,   827,   242,
     246,   901,   180,  -193,  -193,  -193,   243,   180,  -193,   244,
    -193
};
...
{
    -193,  -193,  -193,  -193,  -193,  -193,  -193,    89,  -193,    20,
    -193,  -193,  -193,   283,   -14,  -132,  -193,  -193,  -193,  -193,
    -193,  -193,    75,  -193,     0,     1,  -148,  -193,  -193,    -7,
...
static const yytype_int16 yytable[] =
{
     ...
     226,   234,   235,    25,   187,   260,    26,   254,   255,   256,
     263,   258,    27,   265,   261,   267,   178,   270,   206,   271,
     272,   273,   276,   208,    59,    59,    62,    62,   275,     3,
       4,     5,   115,     6,   305,   280,     7,     8,     9,   282,
      10,    11,    12,   284,   289,   296,    15,    16,   299,   307,
     288,   314,   318,   320,    17,    18,    19,    20,    21,    22,
      23,    24,   233,   283,    30,   252,    25,   310,   297,    26,
...
static const yytype_int16 yycheck[] =
{
     ...
     312,    48,    30,    49,    27,   317,     3,     4,     5,   190,
      ...
      27,    27,    50,    40,   225,   226,    43,    27,     4,    28,
      51,    29,    49,   234,    30,   236,    53,    53,    48,    51,
     251,   252,    50,    52,   251,   252,   251,   252,    41,     3,
       4,     5,    54,     7,    27,    50,    10,    11,    12,    50,
      14,    15,    16,    50,    49,    39,    20,    21,    49,    29,
     271,    29,    29,    29,    28,    29,    30,    31,    32,    33,
      34,    35,   193,   263,     1,   210,    40,   301,   289,    43,
...
#line 2567 "new_parser.tab.c"
    break;

  case 120: /* arr_assign: '{' comma_arr_assign '}'  */
#line 682 "new_parser.y"
              {
...
#line 2635 "new_parser.tab.c"
    break;

  case 127: /* const_expr: const_expr '+' const_expr  */
#line 726 "new_parser.y"
...
#line 2691 "new_parser.tab.c"
    break;

  case 130: /* const_expr: const_expr '/' const_expr  */
#line 767 "new_parser.y"
                                   {(yyval.main).constExp.eletype = mulTypeCheck((yyvsp[-2].main).constExp.eletype, (yyvsp[0].main).constExp.eletype);
...
#line 2720 "new_parser.tab.c"
    break;

  case 132: /* const_expr: const_expr '^' const_expr  */
#line 786 "new_parser.y"
                                   {(yyval.main).constExp.eletype = mulTypeCheck((yyvsp[-2].main).constExp.eletype, (yyvsp[0].main).constExp.eletype);
...
#line 2738 "new_parser.tab.c"
    break;

  case 133: /* const_expr: '-' const_expr  */
#line 799 "new_parser.y"
                        {   
...
#line 2785 "new_parser.tab.c"
    break;

  case 138: /* member_access: memb_access  */
#line 825 "new_parser.y"
                            {
...
#line 2817 "new_parser.tab.c"
    break;

  case 140: /* memb_access: ID arr_access  */
#line 848 "new_parser.y"
                              {
                     int count = checkDims((yyvsp[-1].main).name,(yyvsp[0].main).count);
...
#line 2843 "new_parser.tab.c"
    break;

  case 143: /* $@7: %empty  */
#line 864 "new_parser.y"
                          {
...
#line 3054 "new_parser.tab.c"
    break;


#line 3058 "new_parser.tab.c"
