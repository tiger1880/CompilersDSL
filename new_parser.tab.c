...
{
       0,   195,   195,   196,   197,   212,   224,   224,   224,   253,
     253,   253,   279,   280,   283,   284,   287,   298,   316,   316,
     331,   339,   350,   351,   352,   353,   354,   355,   356,   357,
     360,   366,   369,   369,   378,   387,   388,   392,   394,   395,
     396,   399,   400,   404,   405,   408,   409,   437,   438,   441,
     442,   443,   444,   447,   448,   451,   462,   475,   487,   503,
     504,   508,   510,   513,   514,   517,   518,   524,   525,   526,
     527,   528,   529,   530,   531,   532,   533,   534,   535,   536,
     537,   538,   539,   540,   541,   542,   543,   544,   545,   546,
     547,   548,   549,   550,   551,   555,   556,   560,   561,   562,
     563,   567,   568,   571,   579,   587,   595,   603,   611,   626,
     636,   637,   640,   641,   645,   646,   647,   650,   660,   674,
     682,   691,   700,   711,   712,   715,   724,   727,   741,   755,
     768,   782,   787,   800,   810,   819,   820,   821,   826,   840,
     849,   861,   862,   865,   865,   898,   899,   902,   903,   908,
     916,   923,   930,   939,   946,   958,   959,   962,   962,   969,
     969,   976,   979,   980,   983,   990
};
#endif
...
#line 1607 "new_parser.tab.c"
    break;

  case 3: /* program: program fig  */
#line 196 "new_parser.y"
                     {(yyval.main).text = new string;*(yyval.main).text = *(yyvsp[-1].main).text + *(yyvsp[0].main).text; totalProgram = *(yyval.main).text;}
#line 1613 "new_parser.tab.c"
    break;
...
#line 1691 "new_parser.tab.c"
    break;

  case 9: /* $@3: %empty  */
#line 253 "new_parser.y"
                              { insertType((yyvsp[0].main).name, Func, (yyvsp[-1].main).eletype);  addSymTabPtr(); }
#line 1697 "new_parser.tab.c"
    break;
...
#line 1749 "new_parser.tab.c"
    break;

  case 15: /* list1: argument  */
#line 284 "new_parser.y"
                  {(yyval.main).text = new string;*(yyval.main).text = *(yyvsp[0].main).text;}
#line 1755 "new_parser.tab.c"
    break;
...
#line 1905 "new_parser.tab.c"
    break;

  case 32: /* $@6: %empty  */
#line 369 "new_parser.y"
            { addSymTabPtr(); }
#line 1911 "new_parser.tab.c"
    break;
...
#line 2138 "new_parser.tab.c"
    break;

  case 62: /* vertex: point  */
#line 510 "new_parser.y"
                      { (yyval.main).text = new string;*(yyval.main).text = *(yyvsp[0].main).text; }
#line 2144 "new_parser.tab.c"
    break;
...
#line 2371 "new_parser.tab.c"
    break;

  case 100: /* assign: SUB_ASSIGN_OP expression  */
#line 563 "new_parser.y"
...
#line 2383 "new_parser.tab.c"
    break;

  case 102: /* decl_stmt: constructor id_list ENDLINE  */
#line 568 "new_parser.y"
                                        {typeUpdate((yyvsp[-1].main).nameList, (yyvsp[-2].main).eletype);(yyval.main).text = new string;*(yyval.main).text = *(yyvsp[-2].main).text + *(yyvsp[-1].main).text + ";";}
#line 2389 "new_parser.tab.c"
    break;
...
#line 2425 "new_parser.tab.c"
    break;

  case 106: /* id_list: ID check_arr  */
#line 596 "new_parser.y"
       {
...
#line 2614 "new_parser.tab.c"
    break;

  case 125: /* mult_elements: mult_elements ',' expression  */
#line 716 "new_parser.y"
              {
...
#line 2633 "new_parser.tab.c"
    break;

  case 127: /* const_expr: const_expr '+' const_expr  */
#line 727 "new_parser.y"
...
#line 2652 "new_parser.tab.c"
    break;

  case 128: /* const_expr: const_expr '-' const_expr  */
#line 741 "new_parser.y"
...
#line 2671 "new_parser.tab.c"
    break;

  case 129: /* const_expr: const_expr '*' const_expr  */
#line 755 "new_parser.y"
...
#line 2777 "new_parser.tab.c"
    break;

  case 137: /* const_expr: BOOLEAN  */
#line 821 "new_parser.y"
...
#line 2801 "new_parser.tab.c"
    break;

  case 139: /* memb_access: memb_access '.' ID arr_access  */
#line 840 "new_parser.y"
                                            {
...
#line 2882 "new_parser.tab.c"
    break;

  case 145: /* param_list_opt: param_list  */
#line 898 "new_parser.y"
                            {(yyval.main).text = new string;*(yyval.main).text = *(yyvsp[0].main).text;}
#line 2888 "new_parser.tab.c"
    break;

  case 146: /* param_list_opt: %empty  */
#line 899 "new_parser.y"
                             {(yyval.main).text = new string;*(yyval.main).text = "";}
#line 2894 "new_parser.tab.c"
    break;
...
#line 2900 "new_parser.tab.c"
    break;

  case 148: /* empty_space: %empty  */
#line 903 "new_parser.y"
                                  { (yyval.main).text = new string;*(yyval.main).text = "";}
#line 2906 "new_parser.tab.c"
    break;

  case 149: /* cond_stmt: IF '(' expression ')' empty_space stmt_block ENDLINE  */
#line 909 "new_parser.y"
              {     
                     (yyval.main).stopAdvanceFound = (yyvsp[-1].main).stopAdvanceFound;
...
#line 2973 "new_parser.tab.c"
    break;

  case 155: /* loop: for_loop  */
#line 958 "new_parser.y"
                     { (yyval.main).text = new string;*(yyval.main).text = *(yyvsp[0].main).text; }
#line 2979 "new_parser.tab.c"
    break;

  case 156: /* loop: while_loop  */
#line 959 "new_parser.y"
                     { (yyval.main).text = new string;*(yyval.main).text = *(yyvsp[0].main).text; }
#line 2985 "new_parser.tab.c"
    break;

  case 157: /* $@8: %empty  */
#line 962 "new_parser.y"
                { addSymTabPtr(); }
#line 2991 "new_parser.tab.c"
    break;
...
#line 3002 "new_parser.tab.c"
    break;

  case 159: /* $@9: %empty  */
#line 969 "new_parser.y"
                { addSymTabPtr(); }
#line 3008 "new_parser.tab.c"
    break;
...
#line 3024 "new_parser.tab.c"
    break;

  case 162: /* optional_arg: expression  */
#line 979 "new_parser.y"
                          {(yyval.main).eletype = (yyvsp[0].main).eletype; (yyval.main).text = new string;*(yyval.main).text = *(yyvsp[0].main).text;}
#line 3030 "new_parser.tab.c"
    break;

  case 163: /* optional_arg: %empty  */
#line 980 "new_parser.y"
                          {(yyval.main).eletype = UNDEF;(yyval.main).text = new string;*(yyval.main).text = "";}
#line 3036 "new_parser.tab.c"
    break;
